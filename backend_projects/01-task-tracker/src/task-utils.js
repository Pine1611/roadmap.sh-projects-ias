 ...
 */
const DATA_PATH = config.DATA_PATH === undefined ? process.cwd() + "/task-tracker-data/" : config.DATA_PATH;
const DATA_FILE = config.DATA_FILE === undefined ? "tasks.json" : config.DATA_FILE;
